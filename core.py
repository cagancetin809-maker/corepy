...
MERCY_ROLE = 1468296090678988955
MANAGEBAN_ROLE = 1468296090741772475
TICKET_STAFF_ROLE = 1468296090678988955
TICKET_CATEGORY_ID = 1468296091412992212
...
MERCY_ROLE = 1468296090678988955       # Komutu kullanabilen rol
HITTER_ROLE = 1468296090301239534   # Accept'e basınca verilecek rol
...
async def middlemanpanel(interaction: discord.Interaction):
    ...
    ALLOWED_ROLE = 1468296783879737404  # ❗ Sadece bu rol komutu kullanabilir
    ...
    if interaction.type == discord.InteractionType.component:
        ...
        if interaction.data["custom_id"] == "request_middleman":
            ...
            overwrites = {
                ...
                guild.get_role(1468296090678988955): discord.PermissionOverwrite(view_channel=True, send_messages=True)
            }
...
TOKEN = os.getenv("MTQ2OTM1MTY2MDU3NTkxNjA4NA.G-1eor.T7SAWSo8EfnRdLMf78qy7q6zICQJr3tuwK9jgU")
bot.run("MTQ2OTM1MTY2MDU3NTkxNjA4NA.G-1eor.T7SAWSo8EfnRdLMf78qy7q6zICQJr3tuwK9jgU")
